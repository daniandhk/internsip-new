            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="container">
                    <div class="col-12 py-5">
                        <h1>Register Pelamar</h1>
                    </div>
                    <div class="row">
                        <form method="POST" action="userRegisterForm" class="w-100" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <button class="btn btn-success btn-block btn-lg">Submit</button>
                                    <p class="py-2 pt-4"><a href="{{ url('/register-perusahaan') }}">Register Perusahaan</a></p>
